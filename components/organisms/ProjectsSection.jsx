  ...
  const projects = [
    {
      ...
      links: [
        { label: 'Site', url: 'https://falauai.com.br/' },
        { label: 'Extensão', url: 'https://chromewebstore.google.com/detail/falauai-mensageiro-do-wha/ennhphndgkmknhofggaennkggklbamhe' }
      ],
      image: null,
      isFeatured: true,
    },
